...
Germany is the only country that shows up twice for 2 years for Western Europe, other countries only show up once for a year
Serbia is the same case as Germany, but for Southern Europe
How important God is in people's lives for these two countries increased
...
Interquartile on Views on Income
All 3 regions have the same median and first quartile, but it seems in Europe for the third quartile, income differences should be larger.
