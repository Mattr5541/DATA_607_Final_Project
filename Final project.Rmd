...
clean_eurovis=sce1 %>%
  ...
  mutate(language_category = fct_collapse(first_lang,
                                              Latin_based = c("Portuguese", "Italian", "French", " French","Spanish"," Italian"),
                                              Germanic = c("English", "Icelandic"," Srnán Tongo"," English"),
                                              Slavic=c("Russian","Serbian", "Belarusian","Ukrainian","Slovene"),
                                              Finno_ugric=c("Hungarian","Northern Sami"," Northern Sami"),
                                              Other = c("Albanian")))
